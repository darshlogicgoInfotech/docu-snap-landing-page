        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="lg:pr-8 animate-fade-in">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">
              Scan. Save. Share.
              <span className="block" style={{ color: '#2147A8' }}>Effortlessly.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button size="lg" className="text-lg px-8 py-6 bg-[#2147A8] hover:bg-[#1d3d96] text-white">
                <LogIn className="h-5 w-5 mr-2" />
                Login Now
              </Button>
              <Button size="lg" variant="outline" className="text-lg px-8 py-6 border-[#2147A8] text-[#2147A8] hover:bg-[#2147A8] hover:text-white">
            ...
            <div className="flex items-center gap-8 text-sm text-gray-600">
              <div className="flex items-center">
                <div className="h-12 w-12 bg-blue-50 rounded-lg flex items-center justify-center mr-3">
                  <Smartphone className="h-6 w-6" style={{ color: '#2147A8' }} />
                </div>
                <div>
              ...
              <div className="flex items-center">
                <div className="h-12 w-12 bg-blue-50 rounded-lg flex items-center justify-center mr-3">
                  <div className="font-bold text-lg" style={{ color: '#2147A8' }}>4.8</div>
                </div>
                <div>
          ...
          <div className="mt-12 lg:mt-0 animate-slide-in-right">
            <Card className="p-8 bg-white shadow-xl">
              <div className="aspect-[3/4] bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl flex items-center justify-center">
                <div className="text-center">
                  <ScanLine className="h-24 w-24 mx-auto mb-4" style={{ color: '#2147A8' }} />
                  <p className="font-medium" style={{ color: '#2147A8' }}>App Preview</p>
                  <p className="text-sm text-gray-600 mt-2">Clean Dashboard UI</p>
                </div>
              </div>
